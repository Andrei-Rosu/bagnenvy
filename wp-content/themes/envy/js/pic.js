...
let Kgl = function () {
    ...
    let e = new function () {
        this.create = function () {
            ...
            let i = e[0], a = e[1], o = e[2], n = e[3], s = e[4], u = e[5], c = e[6], f = e[7], h = e[8], l = e[9],
                d = e[10], m = e[11], v = e[12], E = e[13], p = e[14], g = e[15], b = t[0], R = t[1], T = t[2],
                y = t[3], _ = t[4], F = t[5], A = t[6], x = t[7], w = t[8], D = t[9], C = t[10], U = t[11], B = t[12],
                S = t[13], I = t[14], L = t[15];
            ...
            let a = Math.sqrt(r[0] * r[0] + r[1] * r[1] + r[2] * r[2]);
            if (!a) return null;
            let o = r[0], n = r[1], s = r[2];
            1 != a && (o *= a = 1 / a, n *= a, s *= a);
            let u = Math.sin(t), c = Math.cos(t), f = 1 - c, h = e[0], l = e[1], d = e[2], m = e[3], v = e[4], E = e[5],
                p = e[6], g = e[7], b = e[8], R = e[9], T = e[10], y = e[11], _ = o * o * f + c, F = n * o * f + s * u,
                A = s * o * f - n * u, x = o * n * f - s * u, w = n * n * f + c, D = s * n * f + o * u,
                C = o * s * f + n * u, U = n * s * f - o * u, B = s * s * f + c;
            ...
            let a, o, n, s, u, c, f, h, l, d, m = e[0], v = e[1], E = e[2], p = r[0], g = r[1], b = r[2], R = t[0],
                T = t[1], y = t[2];
            ...
            let o = r * Math.tan(e * Math.PI / 360), n = o * t * 2, s = 2 * o, u = i - r;
            ...
            let r = e[0], i = e[1], a = e[2], o = e[3], n = e[4], s = e[5], u = e[6], c = e[7], f = e[8], h = e[9],
                l = e[10], d = e[11], m = e[12], v = e[13], E = e[14], p = e[15], g = r * s - i * n, b = r * u - a * n,
                R = r * c - o * n, T = i * u - a * s, y = i * c - o * s, _ = a * c - o * u, F = f * v - h * m,
                A = f * E - l * m, x = f * p - d * m, w = h * E - l * v, D = h * p - d * v, C = l * p - d * E,
    ...
    }, t = {position: {value: [-1, 1, -1, -1, 1, 1, 1, -1], size: 2}}, r = function (e, t) {
        this.attributes = {}, this.uniforms = {}, this.textureIndexes = {};
        let r = e.gl;
        this.webgl = e;
        let i = t.vertexShaderId, a = t.vertexShader;
        void 0 === a && (a = i ? document.getElementById(i).textContent : "attribute vec2 position;void main(){gl_Position=vec4(position,0.,1.);}");
        let o = t.fragmentShaderId, n = t.fragmentShader;
        void 0 === n && (n = document.getElementById(o).textContent);
        let s = t.attributes, u = t.instancedAttributes, c = t.uniforms, f = t.mode, h = t.drawType;
        void 0 === h && (h = "STATIC_DRAW");
        let l = t.isTransparent;
        void 0 === l && (l = !1);
        let d = t.isAdditive;
        void 0 === d && (d = !1);
        let m = t.isFloats;
        ...
        let E = t.isDepth;
        void 0 === E && (E = !1);
        let p = t.clearedColor, g = !m, b = t.hasResolution;
        void 0 === b && (b = g);
        let R = t.hasCamera;
        void 0 === R && (R = g);
        let T = t.hasLight;
    ...
    r.prototype.createProgram = function (e, t) {
        let r = this.webgl.gl, i = r.createProgram();
        ...
        let r = this.webgl.gl, i = r.createShader(r[e]);
        ...
        Object.keys(e).forEach(function (i) {
            let a = e[i], o = a.value, n = a.size, s = a.isIndices;
            r.addAttribute(i, o, n, s, t)
        })
    }, r.prototype.addAttribute = function (e, t, r, i, a) {
        let o = this.webgl.gl, n = o.getAttribLocation(this.program, e),
            s = this.attributes[e] = {location: n, size: r, data: t, isInstanced: a};
        if (i) {
        ...
        let t = this.webgl.gl, r = this.attributes[e], i = r.location, a = r.size, o = r.vbo, n = r.ibo,
            s = r.isInstanced;
        ...
        let i = this.webgl.gl, a = this.attributes[e], o = a.vbo, n = a.data;
        ...
        let r, i, a = this, o = t, n = function (t, n) {
            switch (t) {
                case"image":
        ...
        if (i) {
            let s, u = this.webgl.gl.getUniformLocation(this.program, e), c = "uniform" + i;
            switch (r) {
                case"image":
                    s = function (e) {
            ...
            Object.defineProperty(this.uniforms, e, {set: s}), void 0 !== o && (this.uniforms[e] = o)
        } else console.error('Failed to add uniform "' + e + '".')
    }, r.prototype.createTexture = function (e, t) {
        if (t) {
            let r = this.webgl.gl, i = r.createTexture(), a = this.textureIndexes[e] = ++this.webgl.textureIndex;
    ...
    let i = "precision highp float;\n#define GLSLIFY 1\n\nuniform vec2 resolution;\nuniform sampler2D texture;\n\nvoid main() {\n  gl_FragColor = texture2D(texture, gl_FragCoord.st / resolution);\n}\n",
        ...
        u = function (e) {
            function t(t) {
                let r = {
                    fragmentShader: a,
                    uniforms: {texture: "framebuffer", radius: 0, isHorizontal: !1},
                    hasCamera: !1,
                    hasLight: !1
                };
            ...
            function t(t, r) {
                ...
                let i = r.threshold;
                void 0 === i && (i = .5);
                let a = {fragmentShader: o, uniforms: {texture: "framebuffer", threshold: i}};
                e.call(this, t, a)
            }
            ...
            function t(t) {
                t.effects.bloomSpecular || (t.effects.bloomSpecular = new c(t, {threshold: .3})), t.effects.bloomBlur || (t.effects.bloomBlur = new u(t)), t.effects.bloomBase || (t.effects.bloomBase = new e(t, {
                    fragmentShader: i,
                    uniforms: {texture: "framebuffer"}
                }));
                let r = {fragmentShader: n, uniforms: {specular: "framebuffer"}, isAdditive: !0, isClear: !1};
            ...
            return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.draw = function (t, r, i, a, o) {
                ...
                let n = this.webgl.effects.bloomBase;
            ...
            function t(t) {
                let r = {
                    fragmentShader: s,
                    uniforms: {texture: "framebuffer", strength: 5, center: [t.canvas.width / 2, t.canvas.height / 2]}
                };
                e.call(this, t, r)
            }
            ...
            function t(t) {
                t.effects.godraySpecular || (t.effects.godraySpecular = new c(t, {threshold: .75})), t.effects.godrayZoomblur || (t.effects.godrayZoomblur = new h(t)), t.effects.godrayBlur || (t.effects.godrayBlur = new u(t)), t.effects.godrayBase || (t.effects.godrayBase = new e(t, {
                    fragmentShader: i,
                    uniforms: {texture: "framebuffer"}
                }));
                let r = {fragmentShader: i, uniforms: {texture: "framebuffer"}, isAdditive: !0, isClear: !1};
            ...
            return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.draw = function (t, r, i, a, o, n, s) {
                ...
                let u = this.webgl.effects.godrayBase;
                u.use(), u.uniforms.texture = t, u.draw(), this.use(), this.uniforms.texture = r, e.prototype.draw.call(this)
            }, t
        }(r), d = function (e) {
            function t(t) {
                t.effects.godraySpecular || (t.effects.godraySpecular = new c(t, {threshold: .75})), t.effects.godrayZoomblur || (t.effects.godrayZoomblur = new h(t)), t.effects.godrayBlur || (t.effects.godrayBlur = new u(t));
                let r = {fragmentShader: i, uniforms: {texture: "framebuffer"}, isAdditive: !0, isClear: !1};
                e.call(this, t, r), this.radius = .02
            }
        ...
        }(r), m = Object.freeze({Blur: u, Bloom: f, Zoomblur: h, Godray: l, GodrayLight: d}), v = function (t) {
            let r = this;
            ...
            let i = t.canvas, a = t.fov, o = t.near;
            void 0 === o && (o = .1);
            let n = t.far;
            void 0 === n && (n = 2e3);
            let s = t.cameraPosition;
            void 0 === s && (s = [0, 0, 30]);
            let u = t.cameraRotation;
            void 0 === u && (u = [0, 0]);
            let c = t.lightDirection;
            void 0 === c && (c = [-1, 1, 1]);
            let f = t.eyeDirection;
            void 0 === f && (f = s);
            let h = t.ambientColor;
            void 0 === h && (h = [.1, .1, .1]);
            let l = t.isClear;
            void 0 === l && (l = !0);
            let d = t.clearedColor, m = t.programs;
            void 0 === m && (m = {});
            let v = t.effects;
            void 0 === v && (v = []);
            let E = t.framebuffers;
            void 0 === E && (E = []);
            let p = t.framebufferFloats;
            void 0 === p && (p = {});
            let g = t.tick, b = t.onBefore, R = t.onResize, T = t.isAutoStart;
            switch (void 0 === T && (T = !0), this.initWebgl(i), this.fov = void 0 !== a ? a : Math.atan(this.canvas.clientHeight / 2 / s[2]) * (180 / Math.PI) * 2, this.near = o, this.far = n, this.cameraPosition = s, this.cameraRotation = u, this.lightDirection = c, this.eyeDirection = f, this.ambientColor = h, this.tick = g, this.onResize = R, this.isClear = l, this.clearedColor = this.isClear ? d || [0, 0, 0, 0] : null, Object.keys(m).forEach(function (e) {
                ...
                case"Object":
                    Object.keys(E).forEach(function (e) {
                        let t = E[e], i = t.width, a = t.height;
                        r.createFramebuffer(e, i, a)
                    })
            }
            Object.keys(p).forEach(function (e) {
                let t = p[e], i = t.width, a = t.height;
                r.createFramebufferFloat(e, i, a)
            }), b && b(), T && this.start()
        };
    return v.prototype.initWebgl = function (e) {
        "string" == typeof e ? this.canvas = document.querySelector(e) : "object" == typeof e && "HTMLCanvasElement" === e.constructor.name ? this.canvas = e : (this.canvas = document.createElement("canvas"), this.canvas.style.display = "block", this.canvas.style.width = "100%", this.canvas.style.height = "100%", document.body.appendChild(this.canvas));
        let t = this.gl = this.canvas.getContext("webgl") || this.canvas.getContext("experimental-webgl");
        ...
        let i = this.gl, a = i.createFramebuffer();
        i.bindFramebuffer(i.FRAMEBUFFER, a);
        let o = i.createRenderbuffer();
        ...
        let n = i.createTexture(), s = ++this.textureIndex;
        ...
        void 0 === t && (t = this.canvas.width), void 0 === r && (r = this.canvas.height);
        let i = this.gl, a = this.framebuffers[e], o = a.framebuffer, n = a.textureIndex, s = a.depthRenderBuffer;
        ...
        void 0 === r && (r = t);
        let i = this.gl, a = i.getExtension("OES_texture_float"), o = i.getExtension("OES_texture_half_float");
        if (a || o) {
            let n = a ? i.FLOAT : o.HALF_FLOAT_OES, s = i.createFramebuffer(), u = i.createTexture(),
                c = ++this.textureIndex;
        ...
        let e = this, t = this.gl, r = this.canvas.clientWidth, i = this.canvas.clientHeight;
        ...
        let t = this, r = this, i = r.fov, a = r.near, o = r.far, n = r.cameraPosition, s = r.cameraRotation,
            u = r.mMatrix, c = r.vMatrix, f = r.pMatrix, h = r.vpMatrix, l = r.mvpMatrix, d = r.invMatrix;
        ...
        let e = this, t = this.lightDirection, r = this.eyeDirection, i = this.ambientColor;
